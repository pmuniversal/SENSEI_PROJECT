...
| 16 | senior-engineer-mode.md | Обращаться с ИИ как со старшим инженером: 10 режимов + ядро-принцип |
...
| Версия | Изменение |
|--------|-----------|
| 2026-06-28 | Добавлен senior-engineer-mode (10 промптов «ИИ как старший инженер») — разослан во все 9 проектов |
